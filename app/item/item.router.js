...
const { Item, ItemJoiSchema, Category, Manufacturer, isOnShelf } = require('./item.model');
...
function generateSearchQuery( requestQuery ){
    ...
    // includes two collections within its properties (manufacturer & category)
...
// get items using different queries as filters including: category, name,
...
itemRouter.get('/:field', (req, res) => {
    let searchList = req.params.field;
...
// get items whose stock is low (if minimumRequired is 
// defined and its value is lower than that)
